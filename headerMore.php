...
<div class="container">	  
		...
		<div class="modal fade" id="dangnhap" role="dialog">
			...
			<div class="modal-content">
				...
				<h4 class ="color-white">Đăng Nhập ______ Đăng Kí</h4>
...
<!-- 					<div class="container">		
						...
						<div class="tab-pane active" id="signIn" role="tabpanel">
							<div class="container"> 
								<div class="row"> 
									...
									<br> 
									<br> 
									<button class="btn btn-background-blue-gradian" type="submit"> Đăng ký</button> 
									</form> 
									</div> 
								</div>
							</div>
						...
						<div class="tab-pane" id="logIn" role="tabpanel">
							<div class="container">		
								<form action="/action_page.php">
									...
									<button type="submit" class="btn btn-background-blue-gradian">Submit</button>
								</form>
							</div>
						</div>
					</div>
				...
				<button type="button" class="btn btn-background-blue-gradian" data-dismiss="modal">Close</button>
				</div>
			</div>				
			</div>
		</div>

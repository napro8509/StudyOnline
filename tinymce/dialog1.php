	...
	<div class="navbar-inner">
		...
		<div class="filters">
			...
			<div class="span4 half">
				<?php if($config['upload_files']){ ?>
				<button id="upload" class="tip btn upload-btn" title="<?php echo trans('Upload_file');?>"><i class="rficon-upload"></i><div>Thêm File</div></button>
				<?php } ?>
				<?php if($config['create_text_files']){ ?>
				<button class="tip btn create-file-btn" title="<?php echo  trans('New_File');?>"><i class="icon-file"></i><div>Tạo File mới</div></button>
				<?php } ?>
				<?php if($config['create_folders']){ ?>
				<button class="tip btn new-folder" title="<?php echo  trans('New_Folder')?>"><i class="icon-folder-open"></i><div>Tạo mới tập tin</div></button>
				<?php } ?>
				...
				<button id="select_multi" class="btn multiple-action-btn btn-inverse" data-function="<?php echo $apply_type;?>"><?php echo trans('Select'); ?></button>
				<?php } ?>
				<?php } ?>
				</div>
			</div>
			...
			<div class="entire types nav-collapse collapse">
...
?>
			...
			<figure data-name="<?php echo $file ?>" data-path="<?php echo $rfm_subfolder.$subdir.$file;?>" data-type="<?php if($is_img){ echo "img"; }else{ echo "file"; } ?>">
				...
				<figcaption>
					...
					<a id="pre_view" class="tip-right preview" title="<?php echo trans('Preview')?>" data-url="<?php echo $src;?>" data-toggle="lightbox" href="#previewLightbox"><i class=" icon-eye-open"></i></a>

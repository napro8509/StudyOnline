                ...
                <div id="tm-section-2" class="tm-section">
                    <div class="tm-container tm-container-wide">
                        <div class="tm-news-item">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 tm-news-item-img-container">
                                <img src="./site/img/images/tt.tt.chienthangdienbienphu.jpg" alt="Image" class="img-fluid tm-news-item-img box-shadow">  
                            </div>
                            <div class="col-2"></div>
                            
                            <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 tm-news-container box-shadow bg-gra-2">
                        ...
                        <div class="tm-news-item">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 flex-order-2 tm-news-item-img-container">
                                <img src="./site/img/images/lich-su-the-gioi.jpg" alt="Image" class="img-fluid tm-news-item-img box-shadow">
                            </div>

                            <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 tm-news-container box-shadow bg-gra-3">
